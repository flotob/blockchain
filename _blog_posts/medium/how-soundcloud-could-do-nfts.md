...
![](/assets/images/medium/2021-03-12_How-SoundCloud-could-do-NFTs-3292067696dc-1*fjcIMsiLr_y9c8rnIAqhhw.png)
...
![](/assets/images/medium/2021-03-12_How-SoundCloud-could-do-NFTs-3292067696dc-1*XF3DysxUegnPVX0u5-yU-w.png)

Source: [https://consensys.net/blog/codefi/how-nft-art-marketplaces-are-merging-with-defi/](https://consensys.net/blog/codefi/how-nft-art-marketplaces-are-merging-with-defi/)
...
Blockchain-wise, the Ethereum blockchain is the main infrastructure used, employing the [ERC721](http://erc721.org/) token standard. Due to transaction cost and concerns with the underlying PoW consensus of Ethereum, second layer solutions and [alternative PoS blockchains](https://xtz.news/nft-news/hicetnunc-introduces-objkts-nft-minter-on-tezos/) are being explored as well.

### What about music?

Recently, the famous rock band Kings of Leon has announced its plans to sell their new album with the help of NFTs.

![](/assets/images/medium/2021-03-12_How-SoundCloud-could-do-NFTs-3292067696dc-1*EQs-yfnezVfoTRvCR7EvKQ.png)
...
There are fundamentally two ways in which digital scarcity can be applied to music. The first one is digital collectibles, and it’s what we’ve seen done by artists like Kings of Leon. [In detail:](https://www.rollingstone.com/pro/news/kings-of-leon-when-you-see-yourself-album-nft-crypto-1135192/)
...
It’s pretty straight-forward. SoundCloud should bootstrap a _DeFi economy_ around scarce digital goods, including the music itself.

**For creators:**

1.  Allow creators to mint NFTs that can represent a number of things — be it a voucher for a concert, a token that represents “nothing” in a factual or legal sense, or a token that mediates factual access to a consumable media file, e.g. a streamable mp3. Give artists the option to configure the smart contract such that they earn on each resale of these NFTs in perpetuity.
2.  Give artists a simple way to sell these NFTs to users, e.g. through auctions. This could happen on artists’ profile pages but also on a dedicated market interface.

**For users:**

1.  Give every user on SoundCloud a self-custodial wallet. In particular SoundClouds mobile app is perfectly suited for that.
2.  Seamlessly integrate peer-to-peer crypto-payments for NFTs by allowing users to top-up their wallets with their credit cards. Basically integrate [MoonPay](https://www.moonpay.io/). As currency for payment use either a stablecoin or a dedicated SoundCloud Payment Token.
3.  Build an NFT-based authentication system where SoundCloud only streams a media file to a user if they own the corresponding NFT.
4.  Provide a set of standard legal terms for creators to use to ensure that vouchers, access to IP and other goods are properly defined and transacted in the market place.
...
![](/assets/images/medium/2021-03-12_How-SoundCloud-could-do-NFTs-3292067696dc-1*2gFGN6oWksFMq1Mhm-WfLQ.jpeg)
...
By [Florian Glatz](https://medium.com/@heckerhut) on [March 12, 2021](https://medium.com/p/3292067696dc).

[Canonical link](https://medium.com/@heckerhut/how-soundcloud-could-do-nfts-3292067696dc)
