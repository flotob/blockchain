...
What has been dubbed the [‘Uber-for-X’](http://www.quora.com/What-startups-are-working-on-Uber-for-X) approach in the startup world, and the transformation to a [on-demand service economy](http://www.ft.com/intl/cms/s/0/96ff50c0-a306-11e4-9c06-00144feab7de.html) by scholars such as Harvard’s [Yochai Benkler](https://cyber.law.harvard.edu/people/ybenkler), turns out to be an interesting subject of study for [economic organization theory](http://en.wikipedia.org/wiki/Theory_of_the_firm). It is interesting to ask what modes of contractual governance occur in the relationships between the platform provider (“Uber”) and its don’t-call-them-employees (“partners”) as well as its customers.

Starting with [Coase](http://en.wikipedia.org/wiki/Ronald_Coase) in 1937, a formal or semi-formal definition of the [_nature of the firm_](http://old.ccer.edu.cn/download/7880-1.pdf) became the [subject of scientific inquiry](https://scholar.google.de/scholar?cites=7821498662025846826&as_sdt=2005&sciodt=0,5&hl=de). Coase’ timeless contribution consists of two fundamental insights: the firm can be understood as the boundary where the price-mechanism of public markets is superseded by non-market-based hierarchical mechanisms of contract governance. To understand the nature of the firm therefore becomes the study of when it is preferable to [_vertically integrate_](http://en.wikipedia.org/wiki/Vertical_integration) some aspects of the firm’s [production function](http://en.wikipedia.org/wiki/Production_function) with the means of a more complex contract regime than is characteristic of the spot contracts of classic exchange markets. The second insight is that the two alternate means of governance entail different costs under certain circumstances: e.g. a resource of which a constant supply is needed may be acquired more cheaply through a long-term supply contract rather than through regular spot exchanges on public markets.

The conceptual framework laid down by Coase is powerful because immediately there come many different reasons to mind when a vertical integration of the firm’s external dependencies may prove cheaper in the long run. Technically, it is of secondary importance, if those reasons are modeled as _transaction costs,_ as Coase did, or some other quantifiable or even non-quantifiable metric\[1\].
...
**Summary**  
We are witnessing a transition from a classical market-governance vs. hierarchical-governance dichotomy as the defining boundary of a firm to a model, where essential market functions are integrated into a new networked environment, governed by a centrally planned algorithmic model that uses more sophisticated signaling mechanisms than classical, _decentralized_ exchange markets (which are coordinated solely through price).
...
_“improving the production or distribution of goods or \[…\] promoting technical or economic progress, while allowing consumers a fair share of the resulting benefit”._
...
Therefore, the only possible way to counter-act one-sided path dependence would be to make the accrued social capital of the network’s agents transferrable between competing firms. Such a prescription may seem irritating at first because what social capital is can be extremely network-specific, such as in the facebook-case. With regards to economic networks of the Uber-kind, however, social capital does seem to be very precisely quantifiable and therefore transferrable, if one thinks e.g. of simple customer ratings. Said differently, the network-effects exerted by Uber-type firms could be significantly diminished if _reputation_ were a transferrable commodity between firms offering similar services and/or addressing similar markets.\[8\]

Footnotes:

\[1\] There is an academic dispute if semi-formal definitions in economics are useful or if the poverty of mathematical models is (more) honest. At least from a legal perspective, this discussion may be compared to the [famous difference between physics and mathematics](https://www.youtube.com/watch?v=obCjODeoLVw).

\[2\] At this point, the looming _Uberification_ of the service sector becomes a [political topic](https://www.youtube.com/watch?v=mBF-GFDaCpE).
...
\[6\] As [mentioned](https://www.zapchain.com/a/FRsI5InA2e) by [Vitalik Buterin](https://about.me/vitalik_buterin) when elaborating on his political views.

\[7\] In a purely [technical meaning](http://en.wikipedia.org/wiki/Greedy_algorithm) of the word.

\[8\] The reasons behind this thinking become more clear when reading about the [Blockchain model and its idea of a public electronic settlement layer](https://medium.com/@heckerhut/smart-contracts-platforms-and-intermediaries-c3d30f5182a6#e011-bb33d68c365b).

By [Florian Glatz](https://medium.com/@heckerhut) on [May 4, 2015](https://medium.com/p/1833629f379b).

[Canonical link](https://medium.com/@heckerhut/modes-of-contractual-governance-in-an-on-demand-service-economy-1833629f379b)
